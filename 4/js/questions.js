window.onload = () => {
    ...
    TFfirst.content ="التركيز على كم كبير من المعلومات المتداخلة، قد يؤثر على الدماغ مما يؤدي إلى تشتت الرؤية لدى المتعلم";
    ...
    TFsecond.content =  "أحيانًا"+" داخل الفصول الدراسية"+" (GPS) "+"تعذر الحصول على إشارات";
